...
CREATE VIRTUAL TABLE IF NOT EXISTS pep_entries USING fts5(
  ...
  date_of_birth,        -- YYYY-MM-DD or partial (YYYY only) — UNINDEXED for exact filter
  nationality,          -- ISO-3166-1 alpha-2 or free text
  program,              -- sanctions program / designation (e.g. "SDGT", "DPRK")
  is_sanctions INTEGER UNINDEXED,  -- 1 = hard sanctions, 0 = PEP-only
